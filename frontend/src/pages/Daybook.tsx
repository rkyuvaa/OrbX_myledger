        ...
        <div className="card bg-white p-0 border border-[#e2e8e6] shadow-xs overflow-hidden print:border-none print:shadow-none">
          ...
          <div className="table-container">
            <table className="data-table daybook-table">
              <thead>
                <tr>
                  <th style={{ width: '11%' }} className="text-center">Voucher #</th>
                  <th style={{ width: '12%' }} className="text-left">Date</th>
                  <th style={{ width: '19%' }} className="text-left">Branch</th>
                  <th style={{ width: '39%' }} className="text-left">Particulars</th>
                  <th style={{ width: '9.5%' }} className="text-right">Received (Cr)</th>
                  <th style={{ width: '9.5%' }} className="text-right">Paid (Dr)</th>
