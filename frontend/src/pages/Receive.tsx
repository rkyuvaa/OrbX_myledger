...
import { AlertCircle, CheckCircle2, Landmark, Wallet, Edit2, PlusCircle, ArrowLeft, X, Receipt } from 'lucide-react';
...
export const Receive: React.FC = () => {
  ...
  const rcvSeq = (sequences || []).find((s: any) => s.voucher_type === 'RCV');
  const nextNum = rcvSeq ? rcvSeq.current_number + 1 : 1;
  const padding = rcvSeq ? rcvSeq.padding : 6;
  const prefix = rcvSeq ? rcvSeq.prefix : 'RCV';
          ...
          <div className="p-6 flex-1 min-h-[220px] flex flex-col justify-center">
            ...
            {step === 3 && (
              <div className="space-y-4 relative">
                <h3 className="text-base font-bold text-[#0d1f1a]">Received From</h3>
                <input
                  type="text"
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  >
                    ...
                    <span className="font-bold text-[10px] text-center">Bank Deposit</span>
                  </button>
                  <button
                    onClick={() => {
                      setValPaymentMode('bank');
                  ...
                  >
                    ...
                    <span className="font-bold text-[10px] text-center">Cash Handover</span>
                  </button>
                </div>
              </div>
            )}
            ...
            {step === 8 && (
              <div className="space-y-4">
                ...
                <textarea
                  placeholder="Write descriptive details about this receipts transaction..."
                  value={valNarration}
                ...
                <div className="grid grid-cols-2 gap-2 text-[11px]">
                  ...
                  <div className="bg-[#f8fafb] p-2 rounded-xl border border-[#e2e8e6] flex justify-between items-center">
                    <div>
                      ...
                      <span className="font-semibold text-[#0d1f1a] truncate max-w-[100px]">{valReceivedFrom || 'Not set'}</span>
                    </div>
